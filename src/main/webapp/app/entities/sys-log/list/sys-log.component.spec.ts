...
describe('SysLog Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'sys-log', component: SysLogComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.sysLogs?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

  describe('trackId', () => {
    it('Should forward to sysLogService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getSysLogIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSysLogIdentifier).toHaveBeenCalledWith(entity);
