...
import { EntityArrayResponseType, SysLogService } from '../service/sys-log.service';
...
export class SysLogComponent implements OnInit {
  ...
  trackId = (_index: number, item: ISysLog): string => this.sysLogService.getSysLogIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.sysLogs = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ISysLog[] | null): ISysLog[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.sysLogService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
